...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       /* glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.3f, 0.2f, 0.1f);
        ...
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.9f, 0.0f, 0.9f);
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 1.0f, 0.5f, 1.0f);

        // Tonos azulados 
        /*glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.05f, 0.05f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.2f, 0.2f, 0.5f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.5f, 0.5f, 0.8f);*/
